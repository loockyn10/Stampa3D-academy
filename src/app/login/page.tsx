...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-stampa-bg text-neutral-100 flex items-center justify-center relative overflow-hidden">
      {/* Glow effects */}
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-stampa-orange/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-stampa-orange/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="mx-auto grid min-h-screen max-w-6xl grid-cols-1 items-center gap-10 px-6 py-12 lg:grid-cols-2 relative z-10 w-full">
        ...
        <div className="hidden lg:flex flex-col justify-center space-y-6">
          <div className="flex items-center gap-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-stampa-orange text-white shadow-lg shadow-stampa-orange/20">
              <Layers className="h-6 w-6" />
            </div>
            <div>
              <h1 className="text-2xl font-bold tracking-tight text-white leading-none">Stampa</h1>
              <p className="text-xs text-stampa-orange mt-1 font-semibold tracking-wider uppercase">Academia 3D</p>
            </div>
          </div>
          ...
          <ul className="space-y-3.5 text-gray-300">
            <li className="flex items-center gap-3">
              <div className="h-2 w-2 rounded-full bg-stampa-orange" />
        ...
        <div className="flex justify-center w-full">
          <div className="w-full max-w-md space-y-8 bg-stampa-bg/80 p-8 sm:p-10 rounded-2xl shadow-2xl border border-stampa-border backdrop-blur-xl">
            {/* Header for mobile view */}
            <div className="flex flex-col items-center lg:items-start">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-stampa-orange text-white mb-4 lg:hidden shadow-lg shadow-stampa-orange/20">
                <Layers className="h-6 w-6" />
              </div>
            ...
            <form className="space-y-6" onSubmit={handleLogin}>
              ...
              <div>
                <button
                  type="submit"
                  disabled={isLoading}
                  className="group relative flex w-full justify-center rounded-xl bg-stampa-orange hover:bg-orange-400 px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-stampa-orange/20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-500 disabled:opacity-70 transition-all active:scale-[0.98]"
                >
                  {isLoading ? (
            ...
            <div className="text-center space-y-3 pt-2 border-t border-stampa-border">
              <p className="text-sm">
                <Link
