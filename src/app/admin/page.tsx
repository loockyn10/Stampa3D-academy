    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Link href="/admin/usuarios" className="block">
          <div className="bg-[#111] p-6 rounded-xl border border-white/10 shadow-sm hover:shadow-md transition-shadow cursor-pointer">
        ...
        <Link href="/admin/cursos" className="block">
          <div className="bg-[#111] p-6 rounded-xl border border-white/10 shadow-sm hover:shadow-md transition-shadow cursor-pointer h-full">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h2 className="text-lg font-semibold text-white">Cursos</h2>
            </div>
            <p className="text-sm text-gray-400">
        ...
        <Link href="/admin/cursos/configuracion" className="block">
          <div className="bg-[#111] p-6 rounded-xl border border-white/10 shadow-sm hover:shadow-md transition-shadow cursor-pointer h-full">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h2 className="text-lg font-semibold text-white">Categorías e Instructores</h2>
            </div>
            <p className="text-sm text-gray-400">
        ...
        <Link href="/admin/stl" className="block">
          <div className="bg-[#111] p-6 rounded-xl border border-white/10 shadow-sm hover:shadow-md transition-shadow cursor-pointer h-full">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h2 className="text-lg font-semibold text-white">Librería STL</h2>
            </div>
            <p className="text-sm text-gray-400">
        ...
        <Link href="/admin/impresoras" className="block">
          <div className="bg-[#111] p-6 rounded-xl border border-white/10 shadow-sm hover:shadow-md transition-shadow cursor-pointer h-full">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h2 className="text-lg font-semibold text-white">Catálogo de Impresoras</h2>
            </div>
            <p className="text-sm text-gray-400">
        ...
        <Link href="/admin/sorteos" className="block">
          <div className="bg-[#111] p-6 rounded-xl border border-white/10 shadow-sm hover:shadow-md transition-shadow cursor-pointer h-full">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h2 className="text-lg font-semibold text-white">Sorteos</h2>
            </div>
            <p className="text-sm text-gray-400">
        ...
        <Link href="/admin/insignias" className="block">
          <div className="bg-[#111] p-6 rounded-xl border border-white/10 shadow-sm hover:shadow-md transition-shadow cursor-pointer h-full">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h2 className="text-lg font-semibold text-white">Insignias</h2>
            </div>
            <p className="text-sm text-gray-400">
        ...
        <Link href="/admin/membresia" className="block">
          <div className="bg-[#111] p-6 rounded-xl border border-white/10 shadow-sm hover:shadow-md transition-shadow cursor-pointer h-full">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h2 className="text-lg font-semibold text-white">Membresía</h2>
            </div>
            <p className="text-sm text-gray-400">
