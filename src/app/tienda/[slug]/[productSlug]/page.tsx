...
import { loadPublicStorefront, loadPublicStorefrontProduct } from "@/lib/business/storefront";
...
async function getPublicData(slug: string, productSlug: string) {
  ...
  return Promise.all([loadPublicStorefront(supabase, slug), loadPublicStorefrontProduct(supabase, slug, productSlug)]);
}
