...
const COURSE_LEVEL_STYLES: Record<CourseLevelKey, CourseLevelStyle> = {
  beginner: {
    key: "beginner",
    label: "Principiante",
    accentClassName: "bg-emerald-500 shadow-[0_4px_16px_rgba(16,185,129,0.28)] group-hover:shadow-[0_5px_22px_rgba(16,185,129,0.4)]",
  ...
  intermediate: {
    key: "intermediate",
    label: "Intermedio",
    accentClassName: "bg-amber-400 shadow-[0_4px_16px_rgba(251,191,36,0.25)] group-hover:shadow-[0_5px_22px_rgba(251,191,36,0.38)]",
  ...
  advanced: {
    key: "advanced",
    label: "Avanzado",
    accentClassName: "bg-red-500 shadow-[0_4px_16px_rgba(239,68,68,0.25)] group-hover:shadow-[0_5px_22px_rgba(239,68,68,0.38)]",
