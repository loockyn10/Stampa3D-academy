...
export function LandingPrintScene() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-stampa-orange/10 blur-[100px] rounded-full hidden md:block" />
      ...
      >
        {/* Holographic Cards */}
        <div className="absolute top-10 -left-10 md:top-20 md:-left-20 bg-zinc-900/60 backdrop-blur-md border border-stampa-border rounded-xl p-4 shadow-[0_0_20px_rgba(234,88,12,0.1)] stampa-float" style={{ animationDelay: '0s', zIndex: 30 }}>
          <div className="text-xs text-gray-400 mb-1">Precio calculado</div>
          <div className="text-lg font-bold text-white">$18.700</div>
        </div>
        
        <div className="absolute bottom-32 -right-10 md:bottom-40 md:-right-20 bg-zinc-900/60 backdrop-blur-md border border-stampa-border rounded-xl p-4 shadow-[0_0_20px_rgba(234,88,12,0.1)] stampa-float" style={{ animationDelay: '2s', zIndex: 30 }}>
        ...
        <div className="absolute -top-4 right-10 md:-top-10 md:right-20 bg-zinc-900/60 backdrop-blur-md border border-stampa-border rounded-xl p-4 shadow-[0_0_20px_rgba(234,88,12,0.1)] stampa-float" style={{ animationDelay: '4s', zIndex: 30 }}>
        ...
        <div className="absolute top-[25%] left-[15%] right-[15%] md:left-[20%] md:right-[20%] h-4 bg-gradient-to-b from-zinc-800 to-zinc-900 border-y border-zinc-700 rounded-sm z-10 shadow-lg flex items-center justify-between">
          <div className="w-6 h-12 bg-stampa-bg border border-zinc-700 rounded-sm -ml-4 shadow-xl" />
          <div className="w-6 h-12 bg-stampa-bg border border-zinc-700 rounded-sm -mr-4 shadow-xl" />
        </div>
        ...
        <div className="absolute top-[22%] z-20 flex flex-col items-center animate-print-head" style={{ animation: 'print-head-move 4s ease-in-out infinite' }}>
          ...
          <div className="w-20 h-10 bg-zinc-800 border border-zinc-600 rounded-md shadow-2xl flex items-center justify-center relative">
            <div className="w-16 h-2 bg-stampa-bg rounded-full" />
          </div>
          ...
          <div className="w-14 h-16 bg-gradient-to-b from-zinc-700 to-zinc-900 border-x border-b border-zinc-600 rounded-b-lg relative flex flex-col items-center pt-2">
            {/* Vents */}
            <div className="w-10 h-1 bg-stampa-bg rounded-full mb-1 opacity-70" />
            <div className="w-10 h-1 bg-stampa-bg rounded-full mb-1 opacity-70" />
            <div className="w-10 h-1 bg-stampa-bg rounded-full opacity-70" />
            {/* Heat block */}
            <div className="absolute bottom-[2px] w-8 h-4 bg-zinc-900 border border-stampa-orange/40 rounded-sm flex items-center justify-center">
               <div className="w-2 h-2 rounded-full bg-stampa-orange shadow-[0_0_8px_rgba(234,88,12,1)]" />
            </div>
            {/* Tip (Nozzle) */}
        ...
        <div className="absolute top-[48%] w-56 h-56 md:w-64 md:h-64 z-10 flex flex-col items-center justify-end" style={{ transform: 'rotateX(60deg) rotateZ(45deg)' }}>
          ...
          <div className="absolute -inset-8 bg-zinc-900/80 border-2 border-zinc-700 rounded-xl shadow-[0_30px_60px_rgba(0,0,0,0.6)]">
            ...
            <div className="absolute inset-0 border border-stampa-orange/10 rounded-xl shadow-[inset_0_0_30px_rgba(234,88,12,0.05)]" />
            {/* Shadow under the piece */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-24 h-24 bg-stampa-bg/60 blur-xl rounded-full" />
          </div>
            ...
            {[...Array(8)].map((_, i) => {
              ...
              return (
                ...
                >
                  ...
                  <div 
                    className="absolute inset-0 bg-stampa-orange/40 animate-print-layer"
                    style={{
