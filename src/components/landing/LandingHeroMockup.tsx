...
export function LandingHeroMockup() {
  return (
    <div className="relative w-full max-w-2xl mx-auto md:animate-[floating_6s_ease-in-out_infinite] [animation-play-state:paused] md:[animation-play-state:running] motion-reduce:[animation-play-state:paused]">
      {/* Glow background */}
      <div className="absolute inset-0 bg-stampa-orange/20 md:bg-stampa-orange/30 blur-[60px] md:blur-[100px] rounded-full" />
      
      {/* Main Mockup Container */}
      <div className="relative bg-stampa-bg/80 backdrop-blur-xl md:backdrop-blur-2xl border border-stampa-border rounded-2xl p-6 shadow-2xl overflow-hidden group">
        
        {/* Mockup Header */}
        <div className="flex items-center gap-3 mb-6 pb-4 border-b border-stampa-border">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          {/* Card 1: Curso Activo */}
          <div className="bg-white/5 border border-stampa-border rounded-xl p-4 hover:bg-white/10 transition-colors duration-300 transform md:hover:-translate-y-1">
          ...
          <div className="flex flex-col gap-4">
            <div className="bg-white/5 border border-stampa-border rounded-xl p-3 flex items-center justify-between hover:bg-white/10 transition-colors duration-300 md:hover:-translate-y-1">
            ...
            <div className="bg-gradient-to-r from-orange-600/20 to-orange-400/20 border border-stampa-orange/30 rounded-xl p-3 flex items-center justify-between hover:bg-stampa-orange/30 transition-colors duration-300 md:hover:-translate-y-1">
              <div className="flex items-center gap-2">
                <Ticket className="w-5 h-5 text-orange-400" />
                <span className="text-sm font-medium text-orange-100">Sorteo Especial</span>
              </div>
              <span className="text-xs text-white bg-stampa-orange px-2 py-1 rounded-full animate-pulse shadow-[0_0_10px_rgba(249,115,22,0.5)]">Activo</span>
            </div>
          </div>
        ...
        <div className="absolute -top-10 -right-10 w-40 h-40 bg-stampa-orange/20 blur-[50px] rounded-full pointer-events-none" />
        <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-stampa-orange/20 blur-[50px] rounded-full pointer-events-none" />
      </div>
