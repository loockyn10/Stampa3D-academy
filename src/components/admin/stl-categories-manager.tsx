                ...
                <>
                  <div className="flex items-center gap-3">
                    {cat.thumbnail_url ? (
                      ...
                      <div className="w-10 h-10 bg-white/5 rounded flex items-center justify-center text-gray-400">?</div>
                    )}
                    <div>
                  ...
                  <div className="flex items-center gap-2">
                    {!cat.is_active && <span className="text-xs px-2 py-0.5 bg-white/5 text-gray-400 rounded">Inactiva</span>}
